...
## read data
path_prefix = "/media/windows/ilyas/data/tuning_curves/Tm1_Tm2_as_HPF/ommatidia_equatorial/runtime_35s/grating/"
...
ac_plots_kwargs = [{'linestyle': '-',
                   ...
                   {'linestyle': '-',
                    ...
                    'mfc': 'black', 
                    'mew': 2,
                    'label': '$\lambda=40^{\circ}$',
                    'lw': 3,
                    'alpha': 0.7},
                   {'linestyle': '-', 
                    'color': 'blue', 'marker': 'x',
                    'markersize': 8, 'mec': 'black',
                    'mfc': 'black', 'mew': 2,
                    'label': '$\lambda=60^{\circ}$',
                    'lw': 3,
                    'alpha': 0.7},
...
for ind in plot_indices:
    ac_objects[1].ana_objects[ind].plot_neuron(ax_grating_v1,
                                               name,
                                               plot_kwargs={'lw': 2.5,
