...
class Connection:
    ...
    A component and sensor should have a list of connections, that hold objects
    of this class. They specify their connections to other components.
    """
    ...
    def __init__(self, weight, target):
        ...
        @param target Component-object that is to be the target of the
        connection.
        """
        self.weight = weight
        self.target = target
